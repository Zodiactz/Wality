...
import 'package:wality_application/wality_app/utils/fab_for_shop.dart';
...
class _ShopPageState extends State<ShopPage> {
                          ...
                          return Padding(
                            ...
                            child: GridView.extent(
                              ...
                              children: [
                                ...
                                _buildStatCard('Total water use',
                                    usedWcoin * 550, Colors.orange),
                              ],
                            ),
                          );
                        },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: const CustomFabForShop(),
