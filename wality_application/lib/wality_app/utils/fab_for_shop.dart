...
class CustomFabForShop extends StatefulWidget {
  const CustomFabForShop({super.key});

  @override
  _CustomFabForShopState createState() => _CustomFabForShopState();
}

class _CustomFabForShopState extends State<CustomFabForShop> {
